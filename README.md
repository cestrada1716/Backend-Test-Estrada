...
[Collection of Postman](https://www.postman.com/cestrada1716?tab=workspaces)

With swagger we need run the project and go to 'cornershop_food/api/v1/docs/'
[Swagger](http://localhost:8000/cornershop_food/api/v1/docs/)