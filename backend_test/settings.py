...
AUTH_USER_MODEL = "users.userCornershop"
...
# SLACK SETTINGS
SLACK_BOT_TOKEN = os.getenv("SLACK_BOT_TOKEN", "xoxb-3683305916518-3718229849488-TKduyXwlde9ZEfoBDcJ6rxGW")
SLACK_CHANNEL = os.getenv("SLACK_CHANNEL", "#food")

# MENU SETTINGS
MENU_URL = SERVER_URL + os.getenv("MENU_URL", "/cornershop_food/api/v1/menu/view/")
